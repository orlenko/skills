...
class WebAssetTests(unittest.TestCase):
    ...
    def test_dashboard_uses_text_dom_operations_and_only_real_mutations(self):
        ...
        self.assertIn("const relativeRequestAge =", script)
        self.assertIn("attention.requested_at", script)
        self.assertIn("Requested ${requestAge}", script)
        self.assertIn("Request time unavailable", script)
